...
<head>
    ...
    <script src="https://kit.fontawesome.com/f48b109bfd.js" crossorigin="anonymous"></script>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li>
                        <a href="{{route('job.post')}}"><button class="btn btn-secondary">Post a Job</button></a>
                        </li>
                        @endif
